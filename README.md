...
### PrimePay (In progress)
A conceptual peer-to-peer transaction app — flows, transaction ledger, UI prototyping using Java + frontend mockups.  
**Why:** Hands-on experience building secure transaction flows and integrating payment-like features.

### Hospital Management System
Desktop application using Java, JDBC and Swing. Handles doctors, patients, appointments and basic billing.  
**Why:** Real-world CRUD, DB design and UI integration experience.

### Plastic-Free Living (Website)
A site dedicated to reducing plastic waste with guides, tips, and community resources.  
`https://zippy-valkyrie-8bc665.netlify.app`

### Text-to-Hash Converter (Servlet + MySQL)
A secure small web utility that takes text input and returns hashed values; implemented with Java Servlets and DB storage.
